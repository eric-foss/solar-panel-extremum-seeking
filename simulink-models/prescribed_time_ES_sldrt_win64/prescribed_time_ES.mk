...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2024a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := prescribed_time_ES
MODULES              := prescribed_time_ES_data.cpp prescribed_time_ES_tgtconn.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp
MAKEFILE             := prescribed_time_ES.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2024a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := prescribed_time_ES_ref.rsp
...
$(notdir $(PRODUCT)).tmp : $(OBJS) $(ALLLIBS) $(SLDRTDIR)/lib/$(TARGETARCH)/sldrtlib.a
	$(PRINTMSG)Linking $(basename $@)
	$(LLD) -shared $(if $(filter 1,$(CC_LISTING)),--Map=$(basename $@).map) -o $@ $(OBJS) $(ALLLIBS) $(SLDRTDIR)/lib/$(TARGETARCH)/sldrtlib.a
